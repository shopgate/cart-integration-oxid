...
class ShopgateOrderExportHelper extends ShopgateObject
{
    ...
    {
        /** @var ShopgateOrder $oxOrderShopgate */
    ...
    {
        $country = Module::getCountryCodeByOxid($this->oxOrder->oxorder__oxbillcountryid->value);
        $state   = Module::getStateCodeByOxid($this->oxOrder->oxorder__oxbillstateid->value);
        ...
        $result->setGender(Module::getGenderByOxidSalutation($this->oxOrder->oxorder__oxbillsal->value));
    ...
    {
        $country = Module::getCountryCodeByOxid($this->oxOrder->oxorder__oxdelcountryid->value);
        $state   = Module::getStateCodeByOxid($this->oxOrder->oxorder__oxdelstateid->value);
    ...
    private function getExternalCoupons()
    {
        ...
        $ids     = Module::dbGetAll("SELECT oxid FROM oxvouchers WHERE oxorderid = '$orderId'");
    ...
    {
        $orderId = $this->oxOrder->oxorder__oxid->value;
        $ids     = Module::dbGetAll("SELECT oxid FROM oxorderarticles WHERE oxorderid = '$orderId'");
