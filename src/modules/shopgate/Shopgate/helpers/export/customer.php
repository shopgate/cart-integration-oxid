...
class ShopgateCustomerExportHelper
{
    ...
    {
        return Module::getGenderByOxidSalutation($this->oxUser->oxuser__oxsal->value);
    }
    ...
    private function getCustomerGroups()
    {
        ...
        foreach (Module::getUserGroupsByUser($this->oxUser) as $oxGroup) {
    ...
    private function buildShopgateAddress($oxAddress)
    {
        ...
        $country   = Module::getCountryCodeByOxid($oxAddress->{"{$tableName}__oxcountryid"}->value);
        $state     = Module::getStateCodeByOxid($oxAddress->{"{$tableName}__oxstateid"}->value);
        ...
        $result->setGender(Module::getGenderByOxidSalutation($oxAddress->{"{$tableName}__oxsal"}->value));
