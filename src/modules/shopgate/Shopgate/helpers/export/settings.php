...
class ShopgateSettingsExportHelper extends ShopgateObject
{
    ...
    {
        $defaultTax = Module::getOxConfig()->getConfigParam('dDefaultVAT');
    ...
    protected function getTaxRates(array $aVats)
    {
        ...
        $countries        = Module::dbGetAll($sSql);
    ...
    private function getHomeCountryCodes()
    {
        ...
        $homeCountryIds   = Module::getOxConfig()->getConfigParam('aHomeCountry');
