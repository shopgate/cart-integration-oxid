...
class ShopgateBasketHelper extends ShopgateObject
{
    ...
    public function buildOxBasket(
        ...
        /** @var Basket $oxBasket */
        $oxBasket = Module::getOxSession()->getBasket();
     ...
     * @throws ShopgateLibraryException
     */
    protected function loadOrderBasket(Basket &$oxBasket, ShopgateCartBase $shopgateOrder)
    {
        $oxBasket->setBasketCurrency(Module::getOxConfig()->getCurrencyObject($shopgateOrder->getCurrency()));
     ...
     * @param ShopgateCartBase  $shopgateOrder
     */
    protected function loadOrderBasketShipping(Basket &$oxBasket, ShopgateCartBase $shopgateOrder)
    {
     ...
     * @param ShopgateCartBase  $shopgateOrder
     */
    protected function loadOrderBasketPayment(Basket &$oxBasket, ShopgateCartBase $shopgateOrder)
    {
    ...
    /**
     * @param Basket $oxidBasket
     * @param ShopgateCartBase  $shopgateCart
     *
     * @post if $oxidBasket supports the setPrice method price will be overwritten
     */
    protected function loadOrderBasketTotal(Basket $oxidBasket, ShopgateCartBase $shopgateCart)
    {
     ...
     * @param ShopgateCartBase  $shopgateOrder
     */
    protected function loadOrderBasketContacts(Basket &$oxBasket, ShopgateCartBase $shopgateOrder)
    {
     ...
     */
    private function createBasketItem(ShopgateOrderItem &$shopgateOrderItem, Basket &$oxBasket)
    {
     ...
     * @param ShopgateCartBase  $shopgateOrder
     */
    protected function loadOrderBasketArticles(Basket &$oxBasket, ShopgateCartBase $shopgateOrder)
    {
        $oxBasket->setDiscountCalcMode(false);
        Module::getOxConfig()->setConfigParam("blOverrideZeroABCPrices", true);
     ...
     *
     */
    protected function addVouchersToBasket(Basket &$oxBasket, ShopgateCartBase $cart)
    {
        $coupons = array();
     ...
     * @throws ShopgateLibraryException
     */
    private function addVoucherToBasket(Basket $oxBasket, ShopgateCoupon $coupon)
    {
        ...
        try {
            if ($coupon instanceof ShopgateShopgateCoupon) {
                ...
                if (_SHOPGATE_ACTION == Plugin::ACTION_ADD_ORDER) {
                    $oxVoucher->save();
    ...
    {
        $result = array();
        $errors = Module::getSessionVar('Errors');
        if (!empty($errors)) {
