...
namespace Shopgate\Oxid\Controller;

use OxidEsales\Eshop\Application\Controller\FrontendController;
use Shopgate\Oxid\Core\Module;

// load Oxid bootstrap.php if applicable
 ...
 */
class ShopgatePluginApi extends FrontendController
{
    /**
     * For performance.
    ...
    {
        $oShopgateFramework = Module::getInstance()->getFramework();
        $oShopgateFramework->handleRequest($_REQUEST);

        Module::getOxUtils()->showMessageAndExit('');
    }
}
